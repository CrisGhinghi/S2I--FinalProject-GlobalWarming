...
export const Artic = () => {
  ...
  return (
    <div className="md:h-[calc(100vh-56px-2rem)] flex flex-col items-center bg-sky-100 dark:bg-sky-900 rounded p-6 ml-2 mr-2 md:mr-4 shadow-md dark:shadow-slate-900 text-sm md:text-base">
      <h1 className="text-4xl md:text-5xl font-bold mb-5 text-blue-900 dark:text-cyan-400">Artic</h1>
      <ul className="prose max-w-screen-lg">
        <p>
          The polar ice, found both in the Arctic and Antarctic, is a key indicator of climate change. Its melting accelerates global warming since ice reflects sunlight, while water absorbs it. The loss of polar ice has severe repercussions not only on the environment but also on animal species and human communities.
        </p>
