...
export const Methane = () => {
  ...
  return (
    <div className="md:h-[calc(100vh-56px-2rem)] flex flex-col items-center bg-sky-100 dark:bg-sky-900 rounded p-6 ml-2 mr-2 md:mr-4 shadow-md dark:shadow-slate-900 text-sm md:text-base">
      <h1 className="text-4xl md:text-5xl font-bold mb-5 text-blue-900 dark:text-cyan-400">Methane</h1>
      <ul className="prose max-w-screen-lg">
        <p>
          Methane is one of the primary greenhouse gases in the atmosphere. Even though it is present in smaller amounts compared to CO2, it has a much greater warming potential. The main sources of methane emissions are agriculture, the production and transportation of coal, oil, and gas, and the decomposition of organic waste in disposal sites.
        </p>
